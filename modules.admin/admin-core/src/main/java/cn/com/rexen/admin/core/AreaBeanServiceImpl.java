 ...
 * 修改备注:  [说明本次修改内容]
 */
public class AreaBeanServiceImpl extends GenericBizServiceImpl<IAreaBeanDao, AreaBean> implements IAreaBeanService {
    ...
    @Override
    public void beforeSaveEntity(AreaBean entity, JsonStatus status) {
