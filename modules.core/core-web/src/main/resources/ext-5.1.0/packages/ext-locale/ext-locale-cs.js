...
Ext.define("Ext.locale.cs.form.field.HtmlEditor", {
    ...
    Ext.apply(Ext.form.field.HtmlEditor.prototype, {
        buttonTips: {
            ...
            forecolor: {title: "Barva písma", text: "Změní barvu textu.", cls: Ext.baseCSSPrefix + "html-editor-tip"},
            justifyleft: {
...
Ext.define("Ext.locale.cs.form.field.File", {override: "Ext.form.field.File", buttonText: "Procházet..."});
Ext.define("Ext.locale.cs.window.MessageBox", {
    override: "Ext.window.MessageBox",
    buttonText: {ok: "OK", cancel: "Storno", yes: "Ano", no: "Ne"}
});
