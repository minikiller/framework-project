...
Ext.define("Ext.locale.da.form.field.HtmlEditor", {
    ...
    Ext.apply(Ext.form.field.HtmlEditor.prototype, {
        buttonTips: {
            ...
            justifycenter: {title: "Centreret", text: "Centrer tekst.", cls: Ext.baseCSSPrefix + "html-editor-tip"},
            justifyright: {title: "Juster højre", text: "Højrestil tekst.", cls: Ext.baseCSSPrefix + "html-editor-tip"},
            insertunorderedlist: {
...
Ext.define("Ext.locale.da.window.MessageBox", {
    ...
    buttonText: {ok: "OK", cancel: "Fortryd", yes: "Ja", no: "Nej"}
});
