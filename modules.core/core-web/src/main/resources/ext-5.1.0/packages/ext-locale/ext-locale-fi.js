...
Ext.define("Ext.locale.fi.form.field.HtmlEditor", {
    ...
    Ext.apply(Ext.form.field.HtmlEditor.prototype, {
        buttonTips: {
            ...
            justifycenter: {title: "Keskitä", text: "Keskitä teksti.", cls: Ext.baseCSSPrefix + "html-editor-tip"},
            justifyright: {
                title: "Tasaa oikealle",
                text: "Tasaa teksti oikeaan reunaan.",
                cls: Ext.baseCSSPrefix + "html-editor-tip"
            },
            insertunorderedlist: {title: "Luettelo", text: "Luo luettelo.", cls: Ext.baseCSSPrefix + "html-editor-tip"},
            insertorderedlist: {
...
Ext.define("Ext.locale.fi.window.MessageBox", {
    ...
    buttonText: {ok: "OK", cancel: "Peruuta", yes: "Kyllä", no: "Ei"}
});
