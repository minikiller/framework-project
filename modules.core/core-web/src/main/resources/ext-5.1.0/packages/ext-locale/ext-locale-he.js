Ext.define("Ext.locale.container.Viewport", {override: "Ext.container.Viewport", requires: ["Ext.rtl.*"], rtl: true});
...
Ext.define("Ext.locale.he.form.field.File", {override: "Ext.form.field.File", buttonText: "עיון ..."});
...
Ext.define("Ext.locale.he.form.field.HtmlEditor", {
    ...
    Ext.apply(Ext.form.field.HtmlEditor.prototype, {
        buttonTips: {
            ...
            italic: {title: "(Ctrl+I) נטוי", text: ".הטה את הטקסט הנבחר", cls: Ext.baseCSSPrefix + "html-editor-tip"},
            underline: {
            ...
            sourceedit: {title: "עריכת קוד מקור", text: ".הצג קוד מקור", cls: Ext.baseCSSPrefix + "html-editor-tip"}
        }
    })
});
...
Ext.define("Ext.locale.he.window.MessageBox", {
    ...
    buttonText: {ok: "אישור", cancel: "ביטול", yes: "כן", no: "לא"}
});
