...
Ext.define("Ext.locale.lv.picker.Month", {override: "Ext.picker.Month", okText: "Labi", cancelText: "Atcelt"});
...
Ext.define("Ext.locale.lv.form.Basic", {override: "Ext.form.Basic", waitTitle: "Lūdzu gaidiet..."});
Ext.define("Ext.locale.lv.tab.Tab", {override: "Ext.tab.Tab", closeText: "Aizvert šo cilni"});
...
Ext.define("Ext.locale.lv.grid.DateColumn", {override: "Ext.grid.DateColumn", format: "d.m.Y"});
...
Ext.define("Ext.locale.lv.window.MessageBox", {
    ...
    buttonText: {ok: "Labi", cancel: "Atcelt", yes: "Jā", no: "Nē"}
});
