...
Ext.define("Ext.locale.tr.form.field.HtmlEditor", {
    ...
    Ext.apply(Ext.form.field.HtmlEditor.prototype, {
        buttonTips: {
            ...
            justifyleft: {title: "Sola Daya", text: "Yazıyı sola daya.", cls: Ext.baseCSSPrefix + "html-editor-tip"},
            justifycenter: {
                title: "Ortala",
                text: "Yazıyı editörde ortala.",
                cls: Ext.baseCSSPrefix + "html-editor-tip"
            },
            justifyright: {title: "Sağa daya", text: "Yazıyı sağa daya.", cls: Ext.baseCSSPrefix + "html-editor-tip"},
            insertunorderedlist: {
                title: "Noktalı Liste",
...
Ext.define("Ext.locale.tr.window.MessageBox", {
    ...
    buttonText: {ok: "Tamam", cancel: "İptal", yes: "Evet", no: "Hayır"}
});
